            ...
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username"> 
                    ...
                    use Illuminate\Support\Facades\Session as FacadesSession;
                        $name = FacadesSession::get('admin_name');
                        if ($name) {
                            echo $name;
                        }
    ?></span>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-brand-product')}}">THEM THUONG HIEU SAN PHAM</a></li>
						<li><a href="{{URL::to('/all-brand-product')}}">LIET KE THUONG HIEU SAN PHAM</a></li>
                    </ul>
                </li>
