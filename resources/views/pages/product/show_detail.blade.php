                ...
                >
                  ...
                  <!-- <div class="carousel-inner">
                    <div class="item active">
                      <a href=""
                        ><img src="{{URL::to('public/fontend/images/similar1.jpg')}}" alt=""
                      /></a>
                      <a href=""
                        ><img src="{{URL::to('public/fontend/images/similar2.jpg')}}" alt=""
                      /></a>
                      <a href=""
                        ><img src="{{URL::to('public/fontend/images/similar3.jpg')}}" alt=""
                      /></a>
                    </div>
                  </div> -->
                      ...
                      <div class="product-image-wrapper">
                        <div class="single-products">
                          <div class="productinfo text-center">
                            ...
                            >
                              <i class="fa fa-shopping-cart"></i>THEM GIO HANG
                            </button>
                          </div>
                        </div>
                      </div>
