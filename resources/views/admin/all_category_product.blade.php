        ...
        <tbody>
          ...
          ?>  
           ...
           ?>
            ...
            <td><span class="text-ellipsis">28/12/11975</span></td>
            <td>
              ...
              <a onclick="return confirm('Ban co chac muon xoa danh muc?');" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active" ui-toggle-class=""><i class="fa fa-trash-o text-danger text"></i></a>
            </td>
          </tr>
          @endforeach
        </tbody>
