          ...
          ?>  
           ...
           ?>
            ...
            <td>
              ...
              <a onclick="return confirm('Ban co chac muon xoa Thuong Hieu?');" href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="active" ui-toggle-class=""><i class="fa fa-trash-o text-danger text"></i></a>
            </td>
          </tr>
          @endforeach
        </tbody>
