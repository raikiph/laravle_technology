          ...
          ?>  
           ...
           ?>
            ...
            <td>
              ...
              <a onclick="return confirm('Ban co chac muon xoa san pham?');" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active" ui-toggle-class=""><i class="fa fa-trash-o text-danger text"></i></a>
            </td>
          </tr>
          @endforeach
        </tbody>
