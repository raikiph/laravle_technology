...
<head>
	...
	<!-- seo -->
	<meta poperty="og:site_image" content="">
	<meta poperty="og:site_name" content="http://localhost/laravel_technology/">
	<meta poperty="og:description" content="{{$meta_desc}}">
	<meta poperty="og:title" content="{{$meta_title}}">
	<meta poperty="og:url" content="{{$url_canonical}}">
	<meta poperty="og:type" content="website">
...
<body>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="cart.html"><i class="fa fa-shopping-cart"></i> Gio hang</a></li>
								<?php
								$customer_id  = Session::get('customer_id');
								if($customer_id!= NULL){
								?>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">San pham<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="shop.html">San pham</a></li>
					...
					<div class="col-sm-5">
						<form action="{{URL::to('/tim-kiem')}}" method="POST">
							...
							<div class="search_box pull-right">
								<input type="text"  name="keyword_submit" placeholder="Tim kiem san pham"/>
								<input type="submit" class="btn btn-primary btn-sm" style="margin-top: 0;color:black;"  name="search_item" value="Tim kiem"/>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="shipping text-center"><!--shipping-->
							<img src="{{URL::to('public/fontend/images/shipping.jpg')}}" alt="" />
						</div><!--/shipping-->
	...
	<div id="fb-root"></div>
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v18.0" nonce="coa7ONo3"></script>
</body>
</html>